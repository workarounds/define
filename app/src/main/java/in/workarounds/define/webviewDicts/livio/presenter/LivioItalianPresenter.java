...
public class LivioItalianPresenter extends LivioBasePresenter {
    ...
    @Inject
    public LivioItalianPresenter(LivioDictionary dictionary, MeaningsController controller, ContextHelper contextHelper) {
        super(dictionary, controller, contextHelper);
    }

    @Override
    protected LivioLanguages.Language getLanguage() {
        return LivioLanguages.italian(DefineApp.getContext());
    }
